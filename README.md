...
1. Create google spreadsheet. For example:
    ...
    ---     | ---     | ---            | ---     | ---                | ---                                                       | ---
    [x]     | general | 10<br>13<br>17 | @dev    | foo/bar<br>foo/baz | WIP/5/There are a lot of things in progress.              | [x]
    [x]     | dev     | 13<br>1750     | @sre    | foo/abc            | needs-review/3/@techlead Please need review.<br>WIP/5/Yo. | [ ]
    [ ]     | ...     | ...            | ...     | ...                | ...                                                       | [ ]
